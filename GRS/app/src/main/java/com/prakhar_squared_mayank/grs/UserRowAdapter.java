...
//
///**
// * Created by Prakhar on 3/30/2016.
// */
//
...
//
//public class UserRowAdapter extends ArrayAdapter<> {
//
//    Context context;
//    int resource, textViewResourceId;
//    List<String> items, tempItems, suggestions;
//
//    public UserRowAdapter(Context context, int resource, int textViewResourceId, List<String> items) {
